...
class MainUseCase {
  ...
  List<Movie> _generateMovies() {
    ...
    List<Movie> movies = List.generate(15, (index) {
      return Movie(
        ...
        director: _generateRandomPerson(random, 'Director ${index + 1}'),
        screenwriter: _generateRandomPerson(random, 'Screenwriter ${index + 1}'),
        operator: _generateRandomPerson(random, 'Operator ${index + 1}'),
  ...
  Person _generateRandomPerson(Random random, String name) {
    return Person(
      name: name,
